...
\missingfigure{Block diagrams of ARMA/ARMAX}
...
\missingfigure{$\lambda graph$}
\missingfigure{Block diagram of the ABS system}
...
\missingfigure{Block diagram of the system}
