...
\begin{itemize}
    ...
    \item $V_1$, $V_2$ and $V_{12}$: $V_2$ is easily built from sensor specifications, while $V_1$ is much more difficult to be designed (it's the most critical design parameter of KF). For what concerns $V_{12}$, we recall that in practice $V_{12}=0$. 
\end{itemize}
